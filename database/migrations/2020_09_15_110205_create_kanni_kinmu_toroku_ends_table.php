...
class CreateKanniKinmuTorokuEndsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kanni_kinmu_toroku_ends', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('kanni_kinmu_toroku_ends');
    }
}
